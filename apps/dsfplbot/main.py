...
async def run_healthcheck_and_bot():
    ...
    try:
        ...
        from apps.dsfplbot.handlers import fun, export_data, link_cancel, link_get_id, link_start, dssdadvice, dssdtempo_cancel, dssdtempo_get_weeks, dssdtempo_start, aftertour, afterdl, start, (
